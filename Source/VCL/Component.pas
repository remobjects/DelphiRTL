...
type
  ...
  TPlatformHandle = {$IF WEBASSEMBLY} dynamic {$ELSEIF ISLAND AND WINDOWS} rtl.HWND {$ELSEIF ISLAND AND LINUX} ^gtk.GtkWidget {$ELSEIF ECHOESWPF} System.Windows.Controls.Control {$ELSEIF MACOS AND NOT MACCATALYST} AppKit.NSResponder {$ELSE} Object {$ENDIF};
